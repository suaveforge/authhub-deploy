const completionCopy = {
  ko:{title:'거의 다 됐어요',subtitle:'계정을 안전하게 복구하고 기록을 보관할 수 있도록 이메일 주소 하나만 확인할게요.',email:'이메일',send:'인증메일 보내기',sending:'보내는 중…',emailHelp:'입력한 이메일의 소유 여부를 확인해요.',sent:'인증번호를 보냈어요.',code:'6자리 인증번호',verify:'확인하고 시작하기',verifying:'확인 중…',resend:'인증번호 다시 받기',resendIn:(n)=>`${n}초 후 다시 받기`,change:'다른 이메일 사용',exit:'나가기',expiredTitle:'로그인이 만료됐어요',expiredSubtitle:'다시 로그인하면 같은 계정에서 이어서 진행할 수 있어요.',restart:'다시 로그인',invalidEmail:'이메일 주소를 확인해 주세요.',usedEmail:'이 이메일은 이미 다른 계정에서 사용 중이에요. 다른 이메일을 입력해 주세요.',badCode:'인증번호가 맞지 않습니다.',expiredCode:'인증번호가 만료됐어요. 새 인증번호를 받아 주세요.',tooMany:'입력 횟수를 초과했어요. 새 인증번호를 받아 주세요.',rate:'잠시 후 다시 시도해 주세요.',delivery:'인증메일을 보내지 못했어요. 잠시 후 다시 시도해 주세요.',session:'로그인 시간이 만료됐어요.',doneElsewhere:'다른 창에서 가입이 완료됐어요. 다시 로그인해 주세요.'},
  en:{title:'Almost there',subtitle:'Verify one email address so your account can be recovered and your records stay safe.',email:'Email',send:'Send verification code',sending:'Sending…',emailHelp:'We only verify that you own this email address.',sent:'We sent a verification code.',code:'6-digit code',verify:'Verify and continue',verifying:'Verifying…',resend:'Resend code',resendIn:(n)=>`Resend in ${n}s`,change:'Use another email',exit:'Exit',expiredTitle:'Your sign-in expired',expiredSubtitle:'Sign in again to resume with the same account.',restart:'Sign in again',invalidEmail:'Check the email address and try again.',usedEmail:'This email is already used by another account. Use a different email.',badCode:'That verification code is not correct.',expiredCode:'The verification code expired. Request a new one.',tooMany:'Too many incorrect attempts. Request a new code.',rate:'Please wait a moment and try again.',delivery:'We could not send the verification email. Try again shortly.',session:'Your sign-in session expired.',doneElsewhere:'Signup was completed in another window. Sign in again.'},
